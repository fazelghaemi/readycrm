...
function csrf_verify():bool{ if(!isset($_POST['csrf_token']) || !hash_equals($_SESSION['csrf']??'',(string)$_POST['csrf_token'])){ http_response_code(400); echo 'درخواست نامعتبر (CSRF).'; return false; } return true; }
