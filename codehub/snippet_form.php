  ...
  <div class="ch-card">
    <div class="ch-head">
      ...
      <div class="ch-actions">
        ...
        <?php if ($id): ?><a class="ch-btn ch-btn-danger" href="snippet_delete.php?id=<?= (int)$id ?>&csrf=<?= e($csrf) ?>" onclick="return confirm('حذف شود؟')">حذف</a><?php endif; ?>
      </div>
    </div>
...
<script src="/codehub/assets/editor.js"></script>
